...
let scrape = async () => {
    ...
    result[1] = await page.$$eval('#tournament_11918 > div:nth-child(2) > div:nth-child(1) > div.c-live-event > a > div > table > tbody > tr:nth-child(1) > td > div > div.ui-live-event__player-name', options => options.map(option => option.textContent));//command
